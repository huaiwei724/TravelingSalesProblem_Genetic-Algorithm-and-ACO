...
namespace GALibrary
{
    ...
    {
        // data fields
        protected OptimizationType optimizationMode;
        protected ObjectiveFunction<T> theObjectiveFunction;
       ...
       // protected double[] AbsoluteObjValues;
        ...
        protected int numberOfCrossoveredChildren = 0;
        protected int numberOfMutatedChildren = 0;
        ...
        [Browsable(false)]
        public double SoFarTheBestObj { get => soFarTheBestObj; }
        [Browsable(false)]
        ...
        public void RunToEnd(RichTextBox rtb = null, int r = 0)
        {
            if (r == 0)
            {
        ...
        public void WriteBestToRichTextBox(RichTextBox rtb, bool ShowLine = true)
        {
            ...
            rtb.AppendText($" best obj = {SoFarTheBestObj}");
        }
